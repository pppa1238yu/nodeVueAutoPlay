        ...
        >
            ...
            <el-table-column label="操作" width="140">
                <template slot-scope="scope">
                    <el-button type="warning" size="small" @click="jumpToDesign(scope.row)">审核</el-button>
                </template>
            </el-table-column>
        </el-table>
        <el-pagination
...
<script lang="ts">
    ...
    export default {
        props: ['taskReviewData', 'handleCurrentChangeReview', 'auditorPageSize', 'loading'],
        methods: {
            jumpToDesign(row) {
